...
def time_modify(t,i,filename_time,root_directory):
    gas_file='gas_{0}'.format(i)
    args_tim=os.path.join(root_directory,gas_file,filename_time)
...
if __name__=='__main__':
    ...
    time_modify(3,7,'water_gas.tim',root_directory)
